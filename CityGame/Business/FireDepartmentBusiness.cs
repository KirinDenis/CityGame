...
{
    public class FireDepartmentBusiness : GameObjectBusiness
    {
        
        public FireDepartmentBusiness(GameBusiness gameBusiness, GameObjectModel gameObjectModel) : base(gameBusiness, gameObjectModel)
        {
