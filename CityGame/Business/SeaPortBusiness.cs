...
{
    public class SeaPortBusiness : GameObjectBusiness
    {
        
        public SeaPortBusiness(GameBusiness gameBusiness, GameObjectModel gameObjectModel) : base(gameBusiness, gameObjectModel)
        {
