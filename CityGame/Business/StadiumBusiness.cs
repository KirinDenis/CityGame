...
{
    public class StadiumBusiness : GameObjectBusiness
    {
        
        public StadiumBusiness(GameBusiness gameBusiness, GameObjectModel gameObjectModel) : base(gameBusiness, gameObjectModel)
        {
