...
{
    public class IndustrialBusiness : GameObjectBusiness
    {
        
        public IndustrialBusiness(GameBusiness gameBusiness, GameObjectModel gameObjectModel) : base(gameBusiness, gameObjectModel)
        {
